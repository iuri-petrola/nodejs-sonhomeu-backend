# docker build e push image
    docker build --build-arg DATABASE_URL="postgresql://user_nodejs_someu:pass_nodejs_someu@postgresql16:5432/db_nodejs_someu?schema=public" --build-arg JWT_SECRET="fbc878419638a610508320c876597c83" -t iuripetrola/nodejs-someu-back:latest . --push 
