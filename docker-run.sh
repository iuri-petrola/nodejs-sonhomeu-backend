...
#    docker run -itd --name postgresql16 -h postgresql16  --net net_nodejs_smk --restart unless-stopped  -p 5432:5432  -v postgresql16:/var/lib/postgresql/data iuripetrola/postgresql:v16 && \
